...
class KnobTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testFalseUserValue(){
        ...
        $expected = false;
        $this->assertEquals($expected, $knob->test(), 'userValue greater than knob threshold should test false');
    }
    ...
    public function testTrueUserValue(){
        ...
        $expected = true;
        $this->assertEquals($expected, $knob->test(), 'userValue less than knob threshold should test true');
    }
